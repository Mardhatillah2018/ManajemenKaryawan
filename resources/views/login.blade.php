                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card-body text-center">
                                <h4 class="mt-3" style="font-family: 'Poppins', sans-serif; font-weight: 600; color: #3A4D6B;">SIGN IN</h4>
                                ...
                                <form method="POST" action="/login">
                                    ...
                                    <button class="btn w-100 py-2 mb-4" type="submit" style="background-color: #3A4D6B; border-color: #3A4D6B; color: white;">Login</button>

                                    <div class="text-center">don't have an account? <a href="/register" style="color: #3A4D6B;">Sign Up</a></div>
                                </form>
                            </div>
                        </div>
                    </div>
