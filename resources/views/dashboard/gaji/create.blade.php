...
<div class="d-flex justify-content-center align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h2 class="h3 text-center" style="color: #3A4D6B;">Input Data Gaji</h2>
</div>
<div class="row">
        ...
        <div class="card-body">
            <form action="/gaji" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('bulan_tahun') is-invalid @enderror" name="bulan_tahun" id="bulan_tahun" value="{{ old('bulan_tahun') }}">
                    @error('bulan_tahun')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="gaji_pokok" readonly>
                </div>

                <div class="mb-3">
                    <label for="bonus" class="form-label">Bonus</label>
                    <input type="number" class="form-control @error('bonus') is-invalid @enderror" name="bonus" id="bonus" value="{{ old('bonus') }}" placeholder="Bonus" oninput="calculateTotalGaji()">
                    @error('bonus')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('potongan') is-invalid @enderror" name="potongan" id="potongan" value="{{ old('potongan') }}" placeholder="Potongan" oninput="calculateTotalGaji()">
                    @error('potongan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('total_gaji') is-invalid @enderror" name="total_gaji" id="total_gaji" readonly>
                    @error('total_gaji')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
<script>
    // mnegisi data karyawan otomatis
