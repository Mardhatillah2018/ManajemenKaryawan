...
<div class="d-flex justify-content-center align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h2 class="h3 text-center" style="color: #3A4D6B;">Input Data Jabatan</h2>
</div>
<div class="row">
        ...
        <div class="card-body">
            <form action="/jabatan" method="post">
                ...
                <div class="mb-3">
                    ...
                    name="nama_jabatan" id="nama_jabatan" value="{{ old('nama_jabatan') }}" placeholder="Nama Jabatan">
                    @error('nama_jabatan')
                ...
                <div class="mb-3">
                    ...
                    name="gaji_pokok" id="gaji_pokok" value="{{ old('gaji_pokok') }}" placeholder="Gaji Pokok">
                    @error('gaji_pokok')
                        <div class=invalid-feedback>
                            {{ $message }}
                        </div>
