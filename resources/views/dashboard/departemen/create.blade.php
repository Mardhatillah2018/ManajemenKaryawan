...
<div class="d-flex justify-content-center align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h2 class="h3 text-center" style="color: #3A4D6B;">Input Data Departemen</h2>
</div>
<div class="row">
        ...
        <div class="card-body">
            <form action="/departemen" method="post">
                ...
                <div class="mb-3">
                    ...
                    name="nama_departemen" id="nama_departemen" value="{{ old('nama_departemen') }}" placeholder="Nama Departemen">
